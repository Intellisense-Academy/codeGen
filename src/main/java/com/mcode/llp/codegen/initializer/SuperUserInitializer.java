...
public class SuperUserInitializer {
    ...
    private static final String SCHEMA_UPDATE_ENDPOINT="/schemas/_doc/users";
    ...
    public void initializeOpenSearch() {
        try {
            ...
            response = openSearchClient.sendRequest(SCHEMA_UPDATE_ENDPOINT,"GET", null);
            if(response.statusCode() == 404){
                ...
                response=openSearchClient.sendRequest(SCHEMA_UPDATE_ENDPOINT, "POST", requestData);
